...
def main():
        ...
        fps= ticks
        exit = False
        ship = pg.image.load("badass2.png").convert_alpha()
...
##                    
            ...
            if nme.position[0] < player.position[0]:
            ...
            elif nme.position[0] > player.position[0]:
               nme.velocity.x += nme.thrust
               
            elif nme.position[1] > player.position[1]:
               ...
               nme.velocity.y -= nme.thrust
                 ...
                 projectiles.append(Projectile(nme.position
                - (nme.rect.width / 8, nme.rect.height / 8) - player.camera, player.direction))
                 for projectile in projectiles:
                     projectile.draw(screen) 
            elif nme.position[0] == max_distance or nme.position[1] == max_distance:
                
                nme.velocity = 0
            elif nme.position[0] > min_distance:
                nme.velocity = 0
                
            elif nme.position[1] > min_distance:
                nme.velocity = 0

            if nme.position == player.position:
                nme.velocity += nme.thrust
