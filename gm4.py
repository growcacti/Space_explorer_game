...
##            playercollide.rect = pg.Rect(player.rect(), player.position)
##            nme.collide.rect = pg.Rect(nme.rect(). nme.position)
##
##            collide1 = playercollide.collderect(nme.collide.rect)
##            if collide1:
##                player.image = pg.image.load("e.png")
##             
##                  
